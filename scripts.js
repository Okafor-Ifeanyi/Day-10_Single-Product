...
const carosuelImage = document.querySelector('.carousel_images')
const carosuelButtons = document.querySelectorAll('.carousel_button');
...
carosuelButtons.forEach( button => {
    button.addEventListener('click', event => {
        ...
        carosuelImage.style.setProperty('--pixel', translateX);
    })
})
